INSERT INTO myapp_country(countryName) VALUES ('Canada');

INSERT INTO myapp_province (provinceName,countryID_id) VALUES ('Ontario',1);
...
INSERT INTO myapp_property_category(propertyCategory) VALUES ('townHouse');
INSERT INTO myapp_property_category(propertyCategory) VALUES ('apartment');
INSERT INTO myapp_property_category(propertyCategory) VALUES ('store');
INSERT INTO myapp_property_category(propertyCategory) VALUES ('farm');
...
insert into main.myapp_property_sector (id, propertySector) values (3, 'commercial');
insert into main.myapp_property_sector (id, propertySector) values (4, 'government');
insert into main.myapp_property_sector (id, propertySector) values (5, 'rural');
insert into main.myapp_property_sector (id, propertySector) values (6, 'other');

insert into main.myapp_property (propertyID, propertyTitle, propertyStreet, propertyStreetNumber, propertyPostalCode, propertyConstructionDate, propertyRegisterationDate, propertyNoofHalls, propertyNoofRooms, propertyNoofBathrooms, propertyNoofFloors, propertyNoofTotalArea, propertyAskingPrice, propertySellingPrice, propertyCategory_id, propertyCity_id, propertyCountry_id, propertyFacing_id, propertyProvince_id, propertySector_id) values (1, '679 Partington Avenue', 'Partington Avenue', 679, 'N9B 2N6', '2016-11-23', '2016-10-24', 1, 6, 2, 2, 1300, 202000, 250000, 1, 22, 1, 1, 2, 2);
